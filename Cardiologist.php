    ...
    <div class="page_container">
        ...
        <div id="main_slider">
            <div class="camera_wrap" id="camera_wrap_1">
                <div data-src="img/specialist/cardiologist/1.jpg"></div>
              
                <div data-src="img/specialist/cardiologist/2.jpg"></div>
                <div data-src="img/specialist/cardiologist/3.jpg"></div>
        ...
        <div class="wrap block">
            <div class="container welcome_block">
            	...
            	Who Is A CARDIOLOGIST?<span>A CARDIOLOGIST is the one who treats heart disease.</span>
        ...
        <div class="wrap block carousel_block">
            <div class="container">
            	<h2 class="upper">Choose Your Favourite CARDIOLOGIST</h2>
            	<div class="row">
                    <div class="span12">
