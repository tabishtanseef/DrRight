    ...
    <div class="page_container">
        ...
        <div id="main_slider">
            <div class="camera_wrap" id="camera_wrap_1">
                <div data-src="img/specialist/gas/1.jpg"></div>
          
                <div data-src="img/specialist/gas/2.jpg"></div>
                <div data-src="img/specialist/gas/3.jpg"></div>				
            </div><!-- #camera_wrap_1 -->
            <div class="clear"></div>	
        </div>        
        <!--//slider-->
        ...
        <div class="wrap block">
            <div class="container welcome_block">
            	<div class="welcome_line welcome_t"></div>
            	 Who Is A GASTROENTEROLOGIST?<span>A GASTROENTEROLOGIST is the one who take cares of our Digestive System.</span>
        ...
        <div class="wrap block carousel_block">
            <div class="container">
            	<h2 class="upper">Choose Your Favourite DERMATOLOGIST</h2>
            	<div class="row">
                    <div class="span12">
