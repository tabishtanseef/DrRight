    ...
    <div class="page_container">
        ...
        <div id="main_slider">
            <div class="camera_wrap" id="camera_wrap_1">
                <div data-src="img/specialist/dentist/9.jpg"></div>
                <div data-src="img/specialist/dentist/10.jpg"></div>
                <div data-src="img/specialist/dentist/12.jpg"></div>
                <div data-src="img/specialist/dentist/13.jpg"></div>				
            </div><!-- #camera_wrap_1 -->
            <div class="clear"></div>	
        </div>        
        <!--//slider-->
        ...
        <div class="wrap block">
            <div class="container welcome_block">
            	...
            	Who Is A DENTIST?<span>A DENTIST is the one who take cares of our Teeth.</span>
        ...
        <div class="wrap block carousel_block">
            <div class="container">
            	<h2 class="upper">Choose Your Favourite DENTIST</h2>
            	<div class="row">
                    <div class="span12">
