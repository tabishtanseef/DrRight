    ...
    <div class="page_container">
        ...
        <div id="main_slider">
            <div class="camera_wrap" id="camera_wrap_1">
                <div data-src="img/specialist/dermo/1.jpg"></div>
          
                <div data-src="img/specialist/dermo/2.jpg"></div>
                <div data-src="img/specialist/dermo/3.jpg"></div>				
            </div><!-- #camera_wrap_1 -->
            <div class="clear"></div>	
        </div>        
        <!--//slider-->
        ...
        <div class="wrap block">
            <div class="container welcome_block">
            	...
            	Who Is A DERMATOLOGIST?<span>A DERMATOLOGIST is the one who take cares of our Skin.</span>
