    ...
    <div class="page_container">
		...
		<!--featured works-->
          <div class="wrap block carousel_block">
            <div class="container">
            	<h2 class="upper">All DOCTORS</h2>
            	<div class="row">
                    <div class="span12">
					<ul id='mycarousel2' class='jcarousel-skin-tango'>
					<?php 
					
			    $get_posts ="select * from user  order by rand()";
        ...
        <div class="wrap block carousel_block">
            <div class="container">
            	<h2 class="upper">Recently Joined DOCTOR</h2>
            	<div class="row">
                    <div class="span12">
					<ul id='mycarousel2' class='jcarousel-skin-tango'>
					<?php 
					
			    $get_posts ="select * from user  order by u_id desc";
				$run_posts= mysqli_query($con, $get_posts);
