...
<body>
						 ...
						 <div class="follow_us">
                        	...
                        	<div class="widget">
                                	<form class="form-search" action="result.php" method="get" enctype="multipart/form-data">
										...
										<input type="text" class="input-medium search-query" placeholder="Specialist" name="spe">
                                        <input type="text" class="input-medium search-query" placeholder="City" name="city">
    ...
    <div class="page_container">
        ...
        <div class="wrap block carousel_block">
            <div class="container">
            	<h2 class="upper">Your Desired Doctors are here.</h2>
            	<div class="row">
                    <div class="span12">
				...
				$get_products= "select * from user where specialist like '%$spe%' AND city like '%$city%'";
				$run_products= mysqli_query($con, $get_products);
				 
				while($row_posts=mysqli_fetch_array($run_products))
				{
					$u_id = $row_posts['u_id'];
					$name = $row_posts['name'];
					$city = $row_posts['city'];
                         ...
                         echo "
                            ...
                            <li>
                            	<div class='post_carousel'>
									...
									<div >"
                                	;?> <?PHP avoid($u_id);?> people are saying for avoiding.</br> <?PHP tri($u_id); ?> people are saying for trying.</br> <?PHP reco($u_id);?> people are recommanding.</br> </a>
                                    <?php echo"</div>
